  ...
  void _onRegister() {
    if (!_agreeToTerms) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Bạn phải đồng ý với Điều khoản dịch vụ và Chính sách bảo mật.'),
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          prefixIcon: const Icon(Icons.public, color: labelColor),
                  ...
                  CustomTextField(
                    ...
                    prefixIcon: const Icon(Icons.person_outline, color: labelColor),
                    validator: (value) {
                  ...
                  CustomTextField(
                    ...
                    prefixIcon: const Icon(Icons.mail_outline, color: labelColor),
                    validator: (value) {
                      if (value == null || value.trim().isEmpty) {
                  ...
                  CustomTextField(
                    ...
                    isPassword: true,
                    prefixIcon: const Icon(Icons.lock_outline, color: labelColor),
                    validator: (value) {
