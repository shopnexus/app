...
mixin _$CheckoutState {
 ...
 CheckoutStep get step; List<Contact> get contacts; Contact? get selectedContact; List<CheckoutItem> get items; List<CartItem> get resolvedItems; bool get buyNow; String get shippingOption; QuoteTransportResponse? get quoteResponse; String get paymentOption; bool get useWallet; List<String> get promotionCodes; CheckoutResponse? get checkoutResponse; CheckoutSummary? get checkoutSummary; bool get isLoading; String? get errorMessage; String get preferredCurrency; Map<String, double> get rates;
...
@override
int get hashCode => Object.hash(runtimeType,step,const DeepCollectionEquality().hash(contacts),selectedContact,const DeepCollectionEquality().hash(items),const DeepCollectionEquality().hash(resolvedItems),buyNow,shippingOption,quoteResponse,paymentOption,useWallet,const DeepCollectionEquality().hash(promotionCodes),checkoutResponse,checkoutSummary,isLoading,errorMessage,preferredCurrency,const DeepCollectionEquality().hash(rates));

@override
String toString() {
  return 'CheckoutState(step: $step, contacts: $contacts, selectedContact: $selectedContact, items: $items, resolvedItems: $resolvedItems, buyNow: $buyNow, shippingOption: $shippingOption, quoteResponse: $quoteResponse, paymentOption: $paymentOption, useWallet: $useWallet, promotionCodes: $promotionCodes, checkoutResponse: $checkoutResponse, checkoutSummary: $checkoutSummary, isLoading: $isLoading, errorMessage: $errorMessage, preferredCurrency: $preferredCurrency, rates: $rates)';
}
...
@useResult
$Res call({
 CheckoutStep step, List<Contact> contacts, Contact? selectedContact, List<CheckoutItem> items, List<CartItem> resolvedItems, bool buyNow, String shippingOption, QuoteTransportResponse? quoteResponse, String paymentOption, bool useWallet, List<String> promotionCodes, CheckoutResponse? checkoutResponse, CheckoutSummary? checkoutSummary, bool isLoading, String? errorMessage, String preferredCurrency, Map<String, double> rates
});
...
/// Create a copy of CheckoutState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? step = null,Object? contacts = null,Object? selectedContact = freezed,Object? items = null,Object? resolvedItems = null,Object? buyNow = null,Object? shippingOption = null,Object? quoteResponse = freezed,Object? paymentOption = null,Object? useWallet = null,Object? promotionCodes = null,Object? checkoutResponse = freezed,Object? checkoutSummary = freezed,Object? isLoading = null,Object? errorMessage = freezed,Object? preferredCurrency = null,Object? rates = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CheckoutStep step,  List<Contact> contacts,  Contact? selectedContact,  List<CheckoutItem> items,  List<CartItem> resolvedItems,  bool buyNow,  String shippingOption,  QuoteTransportResponse? quoteResponse,  String paymentOption,  bool useWallet,  List<String> promotionCodes,  CheckoutResponse? checkoutResponse,  CheckoutSummary? checkoutSummary,  bool isLoading,  String? errorMessage,  String preferredCurrency,  Map<String, double> rates)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CheckoutState() when $default != null:
return $default(_that.step,_that.contacts,_that.selectedContact,_that.items,_that.resolvedItems,_that.buyNow,_that.shippingOption,_that.quoteResponse,_that.paymentOption,_that.useWallet,_that.promotionCodes,_that.checkoutResponse,_that.checkoutSummary,_that.isLoading,_that.errorMessage,_that.preferredCurrency,_that.rates);case _:
  return orElse();
...
class _CheckoutState extends CheckoutState {
  const _CheckoutState({this.step = CheckoutStep.address, final  List<Contact> contacts = const [], this.selectedContact, final  List<CheckoutItem> items = const [], final  List<CartItem> resolvedItems = const [], this.buyNow = false, this.shippingOption = 'Standard', this.quoteResponse, this.paymentOption = 'Stripe', this.useWallet = false, final  List<String> promotionCodes = const [], this.checkoutResponse, this.checkoutSummary, this.isLoading = false, this.errorMessage, this.preferredCurrency = 'USD', final  Map<String, double> rates = const {}}): _contacts = contacts,_items = items,_resolvedItems = resolvedItems,_promotionCodes = promotionCodes,_rates = rates,super._();
...
@override
int get hashCode => Object.hash(runtimeType,step,const DeepCollectionEquality().hash(_contacts),selectedContact,const DeepCollectionEquality().hash(_items),const DeepCollectionEquality().hash(_resolvedItems),buyNow,shippingOption,quoteResponse,paymentOption,useWallet,const DeepCollectionEquality().hash(_promotionCodes),checkoutResponse,checkoutSummary,isLoading,errorMessage,preferredCurrency,const DeepCollectionEquality().hash(_rates));
...
/// Create a copy of CheckoutState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? step = null,Object? contacts = null,Object? selectedContact = freezed,Object? items = null,Object? resolvedItems = null,Object? buyNow = null,Object? shippingOption = null,Object? quoteResponse = freezed,Object? paymentOption = null,Object? useWallet = null,Object? promotionCodes = null,Object? checkoutResponse = freezed,Object? checkoutSummary = freezed,Object? isLoading = null,Object? errorMessage = freezed,Object? preferredCurrency = null,Object? rates = null,}) {
