...
mixin _$CheckoutState {
 ...
 CheckoutStep get step; List<Contact> get contacts; Contact? get selectedContact; List<CheckoutItem> get items; List<CartItem> get resolvedItems; bool get buyNow; String get shippingOption; QuoteTransportResponse? get quoteResponse; String get paymentOption; bool get useWallet; List<String> get promotionCodes; CheckoutResponse? get checkoutResponse; CheckoutResult? get checkoutResult; Transaction? get paymentTransaction; CheckoutSummary? get checkoutSummary; bool get isLoading; String? get errorMessage; String get preferredCurrency; Map<String, double> get rates; bool get agreeToTerms;
...
@override
int get hashCode => Object.hashAll([runtimeType,step,const DeepCollectionEquality().hash(contacts),selectedContact,const DeepCollectionEquality().hash(items),const DeepCollectionEquality().hash(resolvedItems),buyNow,shippingOption,quoteResponse,paymentOption,useWallet,const DeepCollectionEquality().hash(promotionCodes),checkoutResponse,checkoutResult,paymentTransaction,checkoutSummary,isLoading,errorMessage,preferredCurrency,const DeepCollectionEquality().hash(rates),agreeToTerms]);
...
@useResult
$Res call({
 CheckoutStep step, List<Contact> contacts, Contact? selectedContact, List<CheckoutItem> items, List<CartItem> resolvedItems, bool buyNow, String shippingOption, QuoteTransportResponse? quoteResponse, String paymentOption, bool useWallet, List<String> promotionCodes, CheckoutResponse? checkoutResponse, CheckoutResult? checkoutResult, Transaction? paymentTransaction, CheckoutSummary? checkoutSummary, bool isLoading, String? errorMessage, String preferredCurrency, Map<String, double> rates, bool agreeToTerms
});


$ContactCopyWith<$Res>? get selectedContact;$QuoteTransportResponseCopyWith<$Res>? get quoteResponse;$CheckoutResponseCopyWith<$Res>? get checkoutResponse;$CheckoutResultCopyWith<$Res>? get checkoutResult;$TransactionCopyWith<$Res>? get paymentTransaction;$CheckoutSummaryCopyWith<$Res>? get checkoutSummary;
...
class _CheckoutState extends CheckoutState {
  const _CheckoutState({this.step = CheckoutStep.address, final  List<Contact> contacts = const [], this.selectedContact, final  List<CheckoutItem> items = const [], final  List<CartItem> resolvedItems = const [], this.buyNow = false, this.shippingOption = 'Standard', this.quoteResponse, this.paymentOption = 'Stripe', this.useWallet = false, final  List<String> promotionCodes = const [], this.checkoutResponse, this.checkoutResult, this.paymentTransaction, this.checkoutSummary, this.isLoading = false, this.errorMessage, this.preferredCurrency = 'USD', final  Map<String, double> rates = const {}, this.agreeToTerms = true}): _contacts = contacts,_items = items,_resolvedItems = resolvedItems,_promotionCodes = promotionCodes,_rates = rates,super._();
...
@override
int get hashCode => Object.hashAll([runtimeType,step,const DeepCollectionEquality().hash(_contacts),selectedContact,const DeepCollectionEquality().hash(_items),const DeepCollectionEquality().hash(_resolvedItems),buyNow,shippingOption,quoteResponse,paymentOption,useWallet,const DeepCollectionEquality().hash(_promotionCodes),checkoutResponse,checkoutResult,paymentTransaction,checkoutSummary,isLoading,errorMessage,preferredCurrency,const DeepCollectionEquality().hash(_rates),agreeToTerms]);
