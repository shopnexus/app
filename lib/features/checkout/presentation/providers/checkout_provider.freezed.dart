...
@override
int get hashCode => Object.hash(runtimeType,step,const DeepCollectionEquality().hash(contacts),selectedContact,const DeepCollectionEquality().hash(lines),shippingQuotes,transportOption,const DeepCollectionEquality().hash(paymentOptions),paymentOption,checkoutResult,paymentTransaction,paymentSession,isLoading,errorMessage,agreeToTerms);

@override
String toString() {
  return 'CheckoutState(step: $step, contacts: $contacts, selectedContact: $selectedContact, lines: $lines, shippingQuotes: $shippingQuotes, transportOption: $transportOption, paymentOptions: $paymentOptions, paymentOption: $paymentOption, checkoutResult: $checkoutResult, paymentTransaction: $paymentTransaction, paymentSession: $paymentSession, isLoading: $isLoading, errorMessage: $errorMessage, agreeToTerms: $agreeToTerms)';
}
...
@useResult
$Res call({
 CheckoutStep step, List<Contact> contacts, Contact? selectedContact, List<PurchaseLine> lines, ShippingQuotes? shippingQuotes, String? transportOption, List<Option> paymentOptions, String? paymentOption, CheckoutResult? checkoutResult, Transaction? paymentTransaction, PaymentSession? paymentSession, bool isLoading, String? errorMessage, bool agreeToTerms
});
...
/// Create a copy of CheckoutState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? step = null,Object? contacts = null,Object? selectedContact = freezed,Object? lines = null,Object? shippingQuotes = freezed,Object? transportOption = freezed,Object? paymentOptions = null,Object? paymentOption = freezed,Object? checkoutResult = freezed,Object? paymentTransaction = freezed,Object? paymentSession = freezed,Object? isLoading = null,Object? errorMessage = freezed,Object? agreeToTerms = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CheckoutStep step,  List<Contact> contacts,  Contact? selectedContact,  List<PurchaseLine> lines,  ShippingQuotes? shippingQuotes,  String? transportOption,  List<Option> paymentOptions,  String? paymentOption,  CheckoutResult? checkoutResult,  Transaction? paymentTransaction,  PaymentSession? paymentSession,  bool isLoading,  String? errorMessage,  bool agreeToTerms)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CheckoutState() when $default != null:
return $default(_that.step,_that.contacts,_that.selectedContact,_that.lines,_that.shippingQuotes,_that.transportOption,_that.paymentOptions,_that.paymentOption,_that.checkoutResult,_that.paymentTransaction,_that.paymentSession,_that.isLoading,_that.errorMessage,_that.agreeToTerms);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CheckoutStep step,  List<Contact> contacts,  Contact? selectedContact,  List<PurchaseLine> lines,  ShippingQuotes? shippingQuotes,  String? transportOption,  List<Option> paymentOptions,  String? paymentOption,  CheckoutResult? checkoutResult,  Transaction? paymentTransaction,  PaymentSession? paymentSession,  bool isLoading,  String? errorMessage,  bool agreeToTerms)  $default,) {final _that = this;
switch (_that) {
case _CheckoutState():
return $default(_that.step,_that.contacts,_that.selectedContact,_that.lines,_that.shippingQuotes,_that.transportOption,_that.paymentOptions,_that.paymentOption,_that.checkoutResult,_that.paymentTransaction,_that.paymentSession,_that.isLoading,_that.errorMessage,_that.agreeToTerms);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode => Object.hash(runtimeType,step,const DeepCollectionEquality().hash(_contacts),selectedContact,const DeepCollectionEquality().hash(_lines),shippingQuotes,transportOption,const DeepCollectionEquality().hash(_paymentOptions),paymentOption,checkoutResult,paymentTransaction,paymentSession,isLoading,errorMessage,agreeToTerms);
...
/// Create a copy of CheckoutState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? step = null,Object? contacts = null,Object? selectedContact = freezed,Object? lines = null,Object? shippingQuotes = freezed,Object? transportOption = freezed,Object? paymentOptions = null,Object? paymentOption = freezed,Object? checkoutResult = freezed,Object? paymentTransaction = freezed,Object? paymentSession = freezed,Object? isLoading = null,Object? errorMessage = freezed,Object? agreeToTerms = null,}) {
