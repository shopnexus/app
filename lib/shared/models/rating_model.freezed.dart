...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RatingModel&&(identical(other.score, score) || other.score == score)&&(identical(other.count, count) || other.count == count));
}
...
@override
String toString() {
  return 'RatingModel(score: $score, count: $count)';
}
...
/// Create a copy of RatingModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? score = null,Object? count = null,}) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RatingModel&&(identical(other.score, score) || other.score == score)&&(identical(other.count, count) || other.count == count));
}
...
/// Create a copy of RatingModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? score = null,Object? count = null,}) {
