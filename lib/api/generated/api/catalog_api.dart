...
_responseData = rawData == null ? null : deserialize<CategoryList, CategoryList>(rawData, 'CategoryList', growable: true);
  ...
  Future<Response<void>> favoritesListingIDDelete({ 
    ...
    final _path = r'/favorites/{listingID}'.replaceAll('{' r'listingID' '}', listingID.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ListingPage, ListingPage>(rawData, 'ListingPage', growable: true);
  ...
  Future<Response<void>> listingsIdDelete({ 
    ...
    final _path = r'/listings/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<AdminListingsIdApprovalPost200Response, AdminListingsIdApprovalPost200Response>(rawData, 'AdminListingsIdApprovalPost200Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AdminListingsIdApprovalPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminListingsIdApprovalPost200Response>> listingsIdPublicationDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/listings/{id}/publication'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<AdminListingsIdApprovalPost200Response, AdminListingsIdApprovalPost200Response>(rawData, 'AdminListingsIdApprovalPost200Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AdminListingsIdApprovalPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminListingsIdApprovalPost200Response>> listingsIdPublicationPost({ 
    required String id,
...
_responseData = rawData == null ? null : deserialize<AdminListingsIdApprovalPost200Response, AdminListingsIdApprovalPost200Response>(rawData, 'AdminListingsIdApprovalPost200Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [AdminListingsIdApprovalPost200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminListingsIdApprovalPost200Response>> listingsIdVariantsPost({ 
    required String id,
    ...
    final _path = r'/listings/{id}/variants'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<AdminListingsIdApprovalPost200Response, AdminListingsIdApprovalPost200Response>(rawData, 'AdminListingsIdApprovalPost200Response', growable: true);
  ...
  Future<Response<ListingsSuggestionsPost200Response>> listingsSuggestionsPost({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ListingsSuggestionsPost200Response, ListingsSuggestionsPost200Response>(rawData, 'ListingsSuggestionsPost200Response', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConversationsUploadsIdConfirmationPost200Response>> listingsUploadsIdConfirmationPost({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/listings/uploads/{id}/confirmation'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ConversationsUploadsPost201Response, ConversationsUploadsPost201Response>(rawData, 'ConversationsUploadsPost201Response', growable: true);
  ...
  Future<Response<TagPage>> tagsGet({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<TagPage, TagPage>(rawData, 'TagPage', growable: true);
  ...
  Future<Response<AdminListingsIdApprovalPost200Response>> variantsIdDelete({ 
    ...
    final _path = r'/variants/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
