...
class FinanceApi {
  ...
  Future<Response<BankAccountsPost201Response>> bankAccountsIdPatch({
    ...
    return Response<BankAccountsPost201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  paymentSessionsIdCancellationPost({
    ...
    return Response<PaymentSessionsIdGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  paymentSessionsIdPaymentsPost({
    ...
    return Response<PaymentSessionsIdPaymentsPost201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<WalletTransactionPage>> walletsCurrencyTransactionsGet({
    ...
    return Response<WalletTransactionPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
