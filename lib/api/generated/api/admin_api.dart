...
class AdminApi {
  ...
  Future<Response<AdminAccountPage>> adminAccountsGet({
    ...
    return Response<AdminAccountPage>(
      data: _responseData,
  ...
  adminAccountsIdSuspensionDelete({
    ...
    return Response<AdminAccountsIdSuspensionPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminCategoriesPost201Response>> adminCategoriesIdPatch({
    ...
    return Response<AdminCategoriesPost201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<IdentityDocumentPage>> adminIdentityDocumentsGet({
    ...
    return Response<IdentityDocumentPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  adminIdentityDocumentsIdVerdictPost({
    ...
    return Response<AdminIdentityDocumentsIdVerdictPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PaymentSessionPage>> adminPaymentSessionsGet({
    ...
    return Response<PaymentSessionPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminTagsSlugPut200Response>> adminTagsSlugPut({
    ...
    return Response<AdminTagsSlugPut200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  adminTaxInfoAccountIDVerificationPost({
    ...
    return Response<AdminTaxInfoAccountIDVerificationPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminTicketPage>> adminTicketsGet({
    ...
    return Response<AdminTicketPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<AdminTicketsIdGet200Response>> adminTicketsIdGet({
    ...
    return Response<AdminTicketsIdGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  adminWalletsAccountIDAdjustmentsPost({
    ...
    return Response<AdminWalletsAccountIDAdjustmentsPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  adminWithdrawalsIdApprovalPost({
    ...
    return Response<AdminWithdrawalsIdApprovalPost200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
