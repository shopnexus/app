...
class RefundVerdictRequest {
  ...
  RefundVerdictRequest({required this.buyerWins, this.note});

  /// What it does to the money depends on whether the goods have come back; see the endpoint.
  @JsonKey(name: r'buyer_wins', required: true, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is RefundVerdictRequest &&
          other.buyerWins == buyerWins &&
          other.note == note;

  @override
  int get hashCode => buyerWins.hashCode + note.hashCode;

  factory RefundVerdictRequest.fromJson(Map<String, dynamic> json) =>
      _$RefundVerdictRequestFromJson(json);
