...
class UpdateContactRequest {
  ...
  @JsonKey(name: r'clear_address_detail', required: false, includeIfNull: false)
  final bool? clearAddressDetail;

  @JsonKey(name: r'clear_district', required: false, includeIfNull: false)
  final bool? clearDistrict;

  @JsonKey(name: r'clear_location', required: false, includeIfNull: false)
  final bool? clearLocation;

  @JsonKey(name: r'clear_postal_code', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'full_name', required: false, includeIfNull: false)
  final String? fullName;

  @JsonKey(name: r'is_default_delivery', required: false, includeIfNull: false)
  final bool? isDefaultDelivery;

  @JsonKey(name: r'is_default_pickup', required: false, includeIfNull: false)
