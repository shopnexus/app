...
class CartItemsPost201Response {
  ...
  final CartItem data;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CartItemsPost201Response &&
      other.data == data;
  ...
  factory CartItemsPost201Response.fromJson(Map<String, dynamic> json) => _$CartItemsPost201ResponseFromJson(json);
