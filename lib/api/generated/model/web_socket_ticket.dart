...
class WebSocketTicket {
  ...
  WebSocketTicket({required this.expiresIn, required this.ticket});
  ...
  bool operator ==(Object other) =>
      ...
      other is WebSocketTicket &&
          other.expiresIn == expiresIn &&
          other.ticket == ticket;

  @override
  int get hashCode => expiresIn.hashCode + ticket.hashCode;

  factory WebSocketTicket.fromJson(Map<String, dynamic> json) =>
      _$WebSocketTicketFromJson(json);
