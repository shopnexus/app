...
class OrdersIdGet200Response {
  ...
  final Order data;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is OrdersIdGet200Response &&
      other.data == data;
  ...
  factory OrdersIdGet200Response.fromJson(Map<String, dynamic> json) => _$OrdersIdGet200ResponseFromJson(json);
