...
class ListingSuggestion {
  ...
  final int? weightG;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ListingSuggestion &&
  ...
  factory ListingSuggestion.fromJson(Map<String, dynamic> json) => _$ListingSuggestionFromJson(json);
