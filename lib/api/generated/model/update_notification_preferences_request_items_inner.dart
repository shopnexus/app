...
class UpdateNotificationPreferencesRequestItemsInner {
  ...
  bool operator ==(Object other) =>
      ...
      other is UpdateNotificationPreferencesRequestItemsInner &&
          other.category == category &&
          other.channel == channel &&
          other.isEnabled == isEnabled;

  @override
  int get hashCode => category.hashCode + channel.hashCode + isEnabled.hashCode;

  factory UpdateNotificationPreferencesRequestItemsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$UpdateNotificationPreferencesRequestItemsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$UpdateNotificationPreferencesRequestItemsInnerToJson(this);
