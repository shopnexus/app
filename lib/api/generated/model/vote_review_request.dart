...
class VoteReviewRequest {
  ...
  final VoteReviewRequestVoteEnum vote;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is VoteReviewRequest &&
      other.vote == vote;
  ...
  factory VoteReviewRequest.fromJson(Map<String, dynamic> json) => _$VoteReviewRequestFromJson(json);
