...
class ErrorField {
  ...
  ErrorField({required this.field, required this.message, required this.rule});
  ...
  @override
  int get hashCode => field.hashCode + message.hashCode + rule.hashCode;

  factory ErrorField.fromJson(Map<String, dynamic> json) =>
      _$ErrorFieldFromJson(json);
