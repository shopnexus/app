...
class ShippingQuotes {
  ...
  final List<ShippingQuote> options;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ShippingQuotes &&
  ...
  factory ShippingQuotes.fromJson(Map<String, dynamic> json) => _$ShippingQuotesFromJson(json);
