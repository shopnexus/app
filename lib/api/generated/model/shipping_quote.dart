...
class ShippingQuote {
  ...
  final String option;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ShippingQuote &&
      other.fee == fee &&
      other.name == name &&
      other.option == option;
  ...
  factory ShippingQuote.fromJson(Map<String, dynamic> json) => _$ShippingQuoteFromJson(json);
