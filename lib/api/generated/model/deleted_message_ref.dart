...
class DeletedMessageRef {
  ...
  final String id;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DeletedMessageRef &&
  ...
  factory DeletedMessageRef.fromJson(Map<String, dynamic> json) => _$DeletedMessageRefFromJson(json);
