...
class ReviewVoteTally {
  ...
  final int notHelpful;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ReviewVoteTally &&
  ...
  factory ReviewVoteTally.fromJson(Map<String, dynamic> json) => _$ReviewVoteTallyFromJson(json);
